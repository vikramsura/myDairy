...
class ManualMilkCollection extends StatefulWidget {
  const ManualMilkCollection({Key? key}) : super(key: key);

  @override
  State<ManualMilkCollection> createState() => _ManualMilkCollectionState();
}

class _ManualMilkCollectionState extends State<ManualMilkCollection> {
  @override
  void initState() {
                      ...
                      onTap: () {
                        if (provider.dateControler.text.trim().isEmpty) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ManualMilkPage(),
                              ));
                        }
                      },
