...
class SubmitAutomaticMilk extends StatefulWidget {
  const SubmitAutomaticMilk({Key? key}) : super(key: key);

  @override
  State<SubmitAutomaticMilk> createState() => _SubmitAutomaticMilkState();
}

class _SubmitAutomaticMilkState extends State<SubmitAutomaticMilk> {
  @override
  void initState() {
