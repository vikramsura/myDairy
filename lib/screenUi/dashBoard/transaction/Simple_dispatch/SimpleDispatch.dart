...
class SimpleDispatch extends StatefulWidget {
  const SimpleDispatch({Key? key}) : super(key: key);

  @override
  State<SimpleDispatch> createState() => _SimpleDispatchState();
}

class _SimpleDispatchState extends State<SimpleDispatch> {
  @override
  void initState() {
                    ...
                    onTap: () {
                      if (provider.dateControler.text.trim().isEmpty) {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SubmitSimpleDis(),
                            ));
                      }
                    },
