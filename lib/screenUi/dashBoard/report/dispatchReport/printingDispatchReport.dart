...
class PrintingDisPReport extends StatefulWidget {
  DispatchReportModelData PrintingData;

  PrintingDisPReport({Key? key, required this.PrintingData}) : super(key: key);

  @override
  State<PrintingDisPReport> createState() => _PrintingDisPReportState();
}

class _PrintingDisPReportState extends State<PrintingDisPReport> {
          ...
          return pw.Padding(
              ...
              child: pw.Column(
                children: [
                  ...
                  pw.Row(children: [
                    pw.Text(itemText.dispatchReport,
                        style: pw.TextStyle(
                          font: font,
                          fontSize: 20.w,
                        )),
