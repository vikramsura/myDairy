...
class PurchaseSummaryShwoList extends StatelessWidget {
  const PurchaseSummaryShwoList({super.key});
                    ...
                    child: TextField(
                      onChanged: (value) {
                        if (value.trim().isEmpty) {
                          provider.searchPurchaseSummaryList.clear();
                        } else if (value.trim().isNotEmpty) {
                          provider.searchPurchaseSummaryList =
                              provider.searchPurchaseSummary(value.trim());
                        }
                      },
                  ...
                  provider.searchControler.text.trim().isEmpty
                      ? Expanded(
                          child: ListView.builder(
                              itemCount: provider.purchaseSummary.length,
                              shrinkWrap: true,
                              itemBuilder: (context, index) {
                                var item = provider.purchaseSummary[index];
                                return InkWell(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                      ...
                      : Flexible(
                          child: ListView.builder(
                              itemCount:
                                  provider.searchPurchaseSummaryList.length,
                              shrinkWrap: true,
                              itemBuilder: (context, index) {
                                var item =
                                    provider.searchPurchaseSummaryList[index];
                                return InkWell(
                                  onTap: () {
                                    Navigator.push(
                                        context,
