class FarmerMilkBillModel {
  bool? success;
  int? status;
  String? message;
  List<FarmerMilkBillModelData>? data;

  FarmerMilkBillModel({this.success, this.status, this.message, this.data});

  FarmerMilkBillModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <FarmerMilkBillModelData>[];
      json['data'].forEach((v) {
        data!.add(new FarmerMilkBillModelData.fromJson(v));
      });
    }
  }
...
class FarmerMilkBillModelData {
  ...
  FarmerMilkBillModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    bmcId = json['bmc_id'];
    slipId = json['slip_id'];
