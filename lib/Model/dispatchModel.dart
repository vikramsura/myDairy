class DispatchModel {
  ...
  DispatchModel({this.success, this.status, this.message, this.data});
  ...
  DispatchModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <DispatchModelData>[];
      json['data'].forEach((v) {
        data!.add( DispatchModelData.fromJson(v));
      });
    }
  }
...
class DispatchModelData {
  ...
  DispatchModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    shDate = json['sh_date'];
    shift = json['shift'];
