class MilkSlipModel {
  ...
  MilkSlipModel({this.success, this.status, this.message, this.data});

  MilkSlipModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <MilkSlipModelData>[];
      json['data'].forEach((v) {
        data!.add(new MilkSlipModelData.fromJson(v));
      });
    }
  }
...
class MilkSlipModelData {
  ...
  MilkSlipModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    bmcId = json['bmc_id'];
    slipId = json['slip_id'];
